...
- Être en possession de la clé SSH générée dans la phase de déploiement pour se connecter aux différents nœuds.
...
Le script permet de :
-  Vérifier si vous avez les privilèges nécessaires,
-  Approuver les demandes de CSR en cours,
-  Créer le fichier de kubeconfig-bootstrap,
...
## PROCEDURE A REALISER SUR LE NOEUD

- Arrêt du services "kubelet"
...
```
scp -i ~/.ssh/key_ssh rep/kubeconfig-bootstrap core@addresse_ip_noeud:/etc/kubernetes/kubeconfig
```
...
Après quelques minutes le nœud devrait être opérationnel "READY"
